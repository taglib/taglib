...
MACRO(TEST_FLOAT_FORMAT FP_IEEE754)
  IF(NOT FP_IEEE754)
    TRY_COMPILE(HAVE_FLOAT_FORMAT_BIN
      "${CMAKE_CURRENT_BINARY_DIR}" "${CMAKE_CURRENT_SOURCE_DIR}/cmake/TestFloatFormat.c"
    COPY_FILE "${CMAKE_CURRENT_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/TestFloatFormat.bin")
    ...
    IF(HAVE_FLOAT_FORMAT_BIN)
      ...
      FILE(STRINGS "${CMAKE_CURRENT_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/TestFloatFormat.bin"
