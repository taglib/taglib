...
namespace TagLib {
  ...
  namespace RIFF {
    ...
    //! An implementation of RIFF MP3 metadata

    /*!
     * This is implementation of RIFF MP3 metadata.
     */

    namespace RMP3 {

      //! An implementation of TagLib::File with RIFF MP3 specific methods

      /*!
       * This implements and provides an interface for RIFF MP3 (aka RMP3) files to 
       * the TagLib::Tag and TagLib::AudioProperties interfaces by way of implementing
       * the abstract TagLib::File API as well as providing some additional
       * information specific to RIFF MP3 files.
       *
       * The technical description of RIFF MP3 format (in Japanese) is found at:
